...
Integrates ALL features from v1.0 through v1.3 into a production-ready
...
Version: 1.3.0 - Fully Integrated Production System
"""
...
class MainWindow(QMainWindow):
    """
    Main Application Window - Integrated Autonomous Vehicle System

    Production-ready system integrating all v1.0-v1.3 features:
    - Real camera feeds with live processing
    ...
    This is the single entry point for the production autonomous vehicle system.
    """
    ...
    def __init__(self):
        ...
        self.setWindowTitle("Autonomous Vehicle Perception System v1.3.0 [PRODUCTION]")
    ...
    def _create_header(self) -> QWidget:
        ...
        # Title
        title_label = QLabel("🚗 Autonomous Vehicle Perception System [PRODUCTION]")
        title_font = QFont()
    ...
    def _create_footer(self) -> QWidget:
        ...
        self.master_start_button = QPushButton("🚀 START PERCEPTION SYSTEM")
        self.master_start_button.setMinimumSize(250, 50)
    ...
    def _create_status_bar(self):
        ...
        self.status_bar.showMessage("Ready - Click START PERCEPTION SYSTEM to begin")
    ...
    def _start_system(self):
        ...
        try:
            ...
            # Update UI
            self.master_start_button.setText("⏸ STOP PERCEPTION SYSTEM")
            self.master_start_button.setStyleSheet("""
                QPushButton {
            ...
            self.system_log.append("[INFO] ✓ Perception system started successfully!")
            logger.info("Production AV System STARTED")
    ...
    def _stop_system(self):
        ...
        """
        try:
            self.system_log.append("[INFO] Stopping perception system...")
            ...
            # Update UI
            self.master_start_button.setText("🚀 START PERCEPTION SYSTEM")
            self.master_start_button.setStyleSheet("""
                QPushButton {
                    background-color: #28a745;
                    color: white;
            ...
            self.system_log.append("[INFO] Perception system stopped successfully")
            logger.info("Production AV System STOPPED")
...
"""
    ...
    def _show_about(self):
        ...
        QMessageBox.about(
            ...
            "</ul>"
            "<p>Integrated from v1.0 through v1.3 into a single production application.</p>"
